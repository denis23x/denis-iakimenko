...
- [rtp](https://review-to-post.vercel.app) — turns Google reviews into ready-to-post SMM content · Next.js + AI
- [claude code cheatsheet](https://claude-code-cheatsheet.vercel.app) — keyboard reference for Claude Code · used by the Russian-speaking dev community
- [calculon](https://t.me/calculon_x) — Telegram bot that filters and summarizes AI news daily so you don't have to · OpenClaw + MiniMax
- [minilink](https://minilink23x.vercel.app) — URL shortener with auth, custom slugs, and click tracking (vibe code project)
- [daylik](https://daylik.io/en) — team standup and analytics tool in open beta; collects daily updates, surfaces blockers, cuts meeting time
- [deepwood](https://denis23x.itch.io/deepwood) — 2D platformer with combat, levels, and a full game loop; built in Godot 4.3
- [memorease](https://memorease23x.vercel.app) — quiz app for spaced repetition learning (vibe code project)
- ~~[portfolio](https://denis23x.info)~~ — (not maintained)
- ~~[takabase](https://takabase.com)~~ — (rip)

## Certifications

<details><summary>Google Project Management</summary>

[Google Project Management](https://coursera.org/share/8819a9af841955d0a3c6c49d868beb18) (specialization)
...
<details><summary>Anthropic Education</summary>
...
<details><summary>Generative AI Learning Path</summary>
...
<details><summary>AI Fluency</summary>
...
<details class="tags"><summary>Server-side</summary>
...
![Astro](https://img.shields.io/badge/Astro-white?logo=astro&logoColor=%23BC52EE)

</details>

<details class="tags"><summary>Database</summary>
...
<details class="tags"><summary>Test & Observability</summary>
...
<details class="tags"><summary>Environment & DevOps</summary>
...
<details class="tags"><summary>Code Quality</summary>
...
<details class="tags"><summary>AI</summary>
...
Freelance, contract, or full-time (UTC+7) — reach out via [linktr.ee/denis23x](https://linktr.ee/denis23x)
